...
class MoneyTests: XCTestCase {
  ...
  let fifteenCAN = Money(amount: 15, currency: "CAN")
    ...
    // added unit testing
    func testNewString(){
        let money1 = Money(amount: 50, currency: "CAN")
        let money2 = Money(amount: 20, currency: "CAN")
        let money3 = money1.add(money2)
        let money4 = money1 + money2
        let money5 = 20.YEN
        XCTAssert(money3.description == "CAN70")
        XCTAssert(money4.description == "CAN70")
        XCTAssert(money5.description == "YEN20")
    }
